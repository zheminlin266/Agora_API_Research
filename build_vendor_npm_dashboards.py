...
TWILIO_CONFIG = VendorConfig(
    ...
    csv_path=ROOT / "twilio_npm_weekly_downloads.csv",
    html_path=ROOT / "twilio_npm_downloads_dashboard.html",
    meta_path=ROOT / "twilio_npm_downloads_metadata.json",
...
BANDWIDTH_CONFIG = VendorConfig(
    ...
    csv_path=ROOT / "bandwidth_npm_weekly_downloads.csv",
    html_path=ROOT / "bandwidth_npm_downloads_dashboard.html",
    meta_path=ROOT / "bandwidth_npm_downloads_metadata.json",
