...
description: Refresh and validate the Agora PyPI CSV and metadata used by the Agora_API_Research single-page dashboard.
---
...
2. Run `python scripts/build_agora_pypi_dashboard.py` from the repository root.
3. Validate `Data/agora_pypi_weekly_downloads.csv` and `json/agora_pypi_downloads_metadata.json`.
